# Trabajo practico 12 - Despliegue de aplicaciones
...
Integramos el despliegue de nuestra aplicacion en Jenkins
    ...
    stages {
        stage('Build') {
            steps {
                ...
                git branch: 'main', url:
                'https://github.com/Manuel-Bobadilla/spring-boot.git'
        ...
        stage('Heroku'){
            steps {
                ...
                sh 'heroku create jmvjmv'
                sh 'heroku container:push web --app=jmvjmv'
                sh 'heroku container:release web --app=jmvjmv'
            }
        }
    }
}
